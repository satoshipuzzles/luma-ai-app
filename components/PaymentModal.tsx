      ...
      <div className="bg-[#1a1a1a] p-4 md:p-6 rounded-lg space-y-4 max-w-sm w-full">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col space-y-2">
            {/* Bitcoin Connect - Always show this button */}
            <button
              onClick={handleBitcoinConnect}
              disabled={bitcoinConnectPaying || (!bitcoinConnectAvailable && !bitcoinConnectEnabled)}
              className={`w-full text-white font-semibold py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2 ${
                bitcoinConnectAvailable || bitcoinConnectEnabled 
          ...
          <p className="text-xs text-gray-500 text-center mt-1">
            If you've already paid but it's not detecting, click "I've Paid".
